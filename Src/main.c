...
/* USER CODE BEGIN PV */
char command1[] = {0xFF, 0XAA, 0X69, 0X88, 0XB5};
char command2[] = {0xFF, 0xAA, 0x01, 0x01, 0x00};
char command3[] = {0xFF, 0xAA, 0x01, 0x00, 0x00};
char command4[] = {0xFF, 0xAA, 0x00, 0x00, 0x00};
// controller PV
