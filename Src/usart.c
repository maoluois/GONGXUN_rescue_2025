...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PB13     ------> UART5_TX
    */
    GPIO_InitStruct.Pin = CV_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF14_UART5;
    HAL_GPIO_Init(CV_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = CV_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF14_UART5;
    HAL_GPIO_Init(CV_TX_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PB15     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = Daplink_TX_Pin|Daplink_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PB13     ------> UART5_TX
    */
    HAL_GPIO_DeInit(GPIOB, CV_RX_Pin|CV_TX_Pin);
